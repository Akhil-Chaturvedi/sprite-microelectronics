...
private:
  SerialUSB* serial;  // Pointer to avoid type issues
  
public:
  USBTransport() : serial(&Serial) {}
  ...
  bool isConnected() override { return (bool)(*serial); } // USB checks DTR/RTS
};
...
public:
  TransportManager() 
    : uart(Serial1), usb(), active(nullptr) {}
