    ...
    switch (cmd) {
        ...
        case CMD_CLEAR:
            if (len >= 2) {
                ...
                Serial.print("[CMD] CLEAR - Color: 0x");
    ...
    switch (rxState) {
        ...
        case READ_CHECKSUM:
            if (byte == rxChecksum) {
                ...
                Serial.print("[ERR] Checksum mismatch: expected 0x");
...
void setup() {
    ...
    Serial.println("Protocol: 0xAA + CMD + LEN + PAYLOAD + CHECKSUM");
    Serial.println();
